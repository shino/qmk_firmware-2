...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_FINCOL] = LAYOUT_kc(
  //,------+------+------+------+------+------.   ,------+------+------+------+------+------.
      VOLU ,  Q   ,  D   ,  U   ,  C   , MPLY ,      UP  ,  B   ,  N   ,  P   ,  F   , LEFT ,
  //|------+------+------+------+------+------|   |------+------+------+------+------+------|
      VOLD , A_sf ,  O   ,  E   ,  I   ,  V   ,      T   ,  M   ,  S   ,  G   , R_sf , ENT  ,
  //|------+------+------+------+------+------|   |------+------+------+------+------+------|
      WBAK ,  Z   ,  X   ,  W   ,  Y   , ESC  ,     DOWN ,  H   ,  J   ,  K   ,  L   , RGHT ,
  //`------+------+------+------+------+------'   `------+------+------+------+------+------'
  ...
  [_SYMBOL] = LAYOUT_kc( \
  //,------+------+------+------+------+------.   ,------+------+------+------+------+------.
           ,  0   ,  7   ,  8   ,  9   , DEL  ,          , sf_l,  LPRN , RPRN , sf_r ,      ,
  //|------+------+------+------+------+------|   |------+------+------+------+------+------|
           ,  0   ,  4   ,  5   ,  6   , TILD ,     COLN , EQL  , COMM , DOT  , SLSH ,      ,
  //|------+------+------+------+------+------|   |------+------+------+------+------+------|
           ,  0   ,  1   ,  2   ,  3   ,      ,          , PLUS , COLN , SCLN , TILD ,      ,
  //`------+------+------+------+------+------'   `------+------+------+------+------+------'
                                ,      ,      ,          ,      ,
  //                     `------+------+------'   `------+------+------'
  ),
  ...
  [_S_SYMB] = LAYOUT_kc( \
  //,------+------+------+------+------+------.   ,------+------+------+------+------+------.
           ,      , AMPR , ASTR ,      ,      ,          ,      , LBRC , RBRC ,      , RSET ,
  //|------+------+------+------+------+------|   |------+------+------+------+------+------|
           , PIPE , DLR  , PERC , CIRC ,      ,          , DQUO ,  LT  ,  GT  , QUES ,      ,
  //|------+------+------+------+------+------|   |------+------+------+------+------+------|
           , BSLS , EXLM ,  AT  , HASH ,      ,          , QUOT , LCBR , RCBR , GRV  ,      ,
  //`------+------+------+------+------+------'   `------+------+------+------+------+------'
                                ,      ,      ,          ,      ,
  //                     `------+------+------'   `------+------+------'
  ),
